...
class IntensityCalculator:
    ...
    def output_href(self):
        ...
        ratios = pd.read_csv(self.path + 'preprocessing/protein_ratios.csv')
        ...
        light_hnorm.to_csv(self.path + 'protein intensities/light_href.csv', sep=',')  
        nsp_hnorm.to_csv(self.path + 'protein intensities/nsp_href.csv', sep=',')
        total_hnorm.to_csv(self.path + 'protein intensities/total_href.csv', sep=',')
        reference.to_csv(self.path + 'protein intensities/reference_href.csv', sep=',')
    ...
    def output_unnorm(self, contains_reference, pulse_channel='M'):
        self.create_protein_intensity_directory()
    ...
    def output_dlfq(self, pulse_channel='M'):
        self.create_protein_intensity_directory()
