...
# Installation
Make a new env with conda e.g. conda create --name myenv python=3.8

Use the following commands with conda to install requirements:
conda install pip
pip install directlfq
conda install -c anaconda pytables
pip install alphastats
conda install jupyter and spyder
(additional requirements will be needed but aren't added at this point)
