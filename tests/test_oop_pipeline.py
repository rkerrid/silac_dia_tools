...
if __name__ == "__main__":
    ...
    pipeline = Pipeline( 'G:/My Drive/Data/data/spikein data/', 'filtering_parameters_strict.json', contains_reference = False, pulse_channel="M", meta="meta.csv")
   
    # pipeline.make_metadata('G:/My Drive/Data/data/spikein data/')
